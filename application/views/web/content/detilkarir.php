          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-8 col-xs-12">
                <div class="post">
                  <div class="__main">
                    <div class="__title"><a href="blog-single-standard.html"><?php echo $karir->title_ina ?></a></div>
                    <div class="__meta"><span>Posted:&nbsp;<span class="__value"><?php echo $karir->post_date ?></span></span><span>By:&nbsp;<span class="__value"><?php echo $karir->name ?></span></span>
                    </div>
                    ...
                    <div class="__content"><p><?php echo $karir->content_ina; ?></p></div>
                  </div>
                </div>
              </div>
            </div>
