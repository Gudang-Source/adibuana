              ...
              foreach ($kegiatan as $q_kegiatan) {
                echo'
                  <div class="post  post-index post-left-image">
                    ...
                    <div class="__main">
                      <div class="__title"><a href="blog-single-standard.html">';?><?php echo $q_kegiatan->title_ina; ?><?php echo'</a></div>
                      ...
                      <div class="__content">';?><?php echo $q_kegiatan->lead_ina; ?> <?php echo' </div>
