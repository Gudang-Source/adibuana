			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Add Faculty Area</h5>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/fakultas_area/insert" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Area (Indonesian)*</label>
                      <div class="col-sm-6">
                        <input type="text" name="area_ina" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Area (English)*</label>
                      <div class="col-sm-6">
                        <input type="text" name="area_eng" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="alt_fax" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Google Latitude</label>
                      <div class="col-sm-6">
                        <input type="text" name="google_lat" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Google Longitude</label>
                      <div class="col-sm-6">
                        <input type="text" name="google_long" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
