			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Add Faculty Type</h5>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/fakultas_tipe/insert" enctype="multipart/form-data">
                  <div class="box-body">
