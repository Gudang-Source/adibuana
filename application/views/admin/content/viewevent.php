							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $event->title_ina ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $event->title_eng ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $event->content_ina ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $event->content_eng ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $event->hot ?></div>
										</div>
									</div>
