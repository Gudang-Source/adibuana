                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <input type="date" name="start_date" class="form-control" value="<?php echo $event->start_date ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">End Date *</label>
                      <div class="col-sm-3">
                        <input type="date" name="end_date" class="form-control" value="<?php echo $event->end_date ?>">
                      </div>
                    </div>
                    <div class="form-group">
