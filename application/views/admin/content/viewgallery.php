						...
						<form class="form-horizontal" action="#">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">View Gallery</h5>
								...
								<div class="panel-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $gallery->katagori ?></div>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $gallery->title_ina ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $gallery->title_eng ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $gallery->lead_ina ?></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<div class="form-control-static"><?php echo $gallery->lead_eng ?></div>
										</div>
									</div>
